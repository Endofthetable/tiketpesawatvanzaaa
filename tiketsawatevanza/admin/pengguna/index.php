...
<body class="flex">
    ...
    <div class="flex-1 p-6 animate-slide">
        ...
        <a href="tambah.php" class="add-btn inline-flex items-center bg-blue-600 text-white px-4 py-2 rounded-lg mb-6 animate-fade">
            <i class="fas fa-plus-circle mr-2"></i>
            Tambah Pengguna
        </a>

        <div class="table-container animate-fade delay-100">
            <table class="min-w-full">
                <thead>
                    <tr class="table-header">
                        ...
                        <th class="py-3 px-4 text-left">
                            <i class="fas fa-user-tag header-icon"></i>
                            Roles
                        </th>
                ...
                <tbody>
                    ...
                    <tr class="table-row">
                        <td><?= $no; ?></td>
                        <td class="font-medium"><?= $data["username"]; ?></td>
                        <td><?= $data["nama_lengkap"]; ?></td>
                        <td>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium 
                                <?= $data["roles"] === 'Petugas' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800' ?>">
                                <?php if($data["roles"] === 'Petugas'): ?>
    ...
    <script>
        // Add animation to table rows as they load
