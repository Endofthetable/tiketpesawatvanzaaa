...
if (isset($_POST["edit"])) {
    if (edit($_POST) > 0) {
        ...
        Swal.fire({
            title: 'Gagal!',
            text: 'Jadwal penerbangan gagal diperbarui',
            icon: 'error',
    ...
    <div class="flex-1 p-6 animate-slide">
        <div class="mb-8">
            ...
            <h2 class="text-xl font-semibold text-gray-600 mt-2 flex items-center">
                <i class="fas fa-calendar-edit mr-2 text-blue-400"></i>
            ...
            <div class="mb-6">
                ...
                <select name="id_rute" id="id_rute" 
                    ...
                    <option value="<?= $jadwal["id_rute"]; ?>">
                        <?= $jadwal["nama_maskapai"]; ?> - <?= $jadwal["rute_asal"]; ?> ke <?= $jadwal["rute_tujuan"]; ?>
                    </option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    ...
                    <input type="number" name="harga" id="harga" 
                        class="form-input w-full p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" 
                        value="<?= $jadwal["harga"]; ?>" placeholder="Masukkan harga tiket" required>
                ...
                <div>
                    ...
                    <input type="number" name="kapasitas_kursi" id="kapasitas_kursi" 
                        class="form-input w-full p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" 
                        value="<?= $jadwal["kapasitas_kursi"]; ?>" placeholder="Masukkan kapasitas kursi" required>
